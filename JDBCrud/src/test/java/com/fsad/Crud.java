...
public class Crud {
    ...
    static void viewDepartments() {
        try (Connection con = DriverManager.getConnection(url, user, password);
             Statement st = con.createStatement();
             ResultSet rs = st.executeQuery("SELECT dept_id, dept_name FROM dept")) {
    ...
    static void insertEmployee() {
        try (Connection con = DriverManager.getConnection(url, user, password)) {
            ...
            System.out.print("Enter Dept ID (from above list): ");
            ...
            System.out.println("❌ Invalid Department ID! Insert department first.");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
